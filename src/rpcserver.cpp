...
int64_t AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > Params().MaxMoney())
...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "Stop Emptycoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Emptycoin server stopping";
}
...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "listexterioraddresses",  &listexterioraddresses,  true,      true,      true },
    { "listinterioraddresses",  &listinterioraddresses,  true,      true,      true },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use emptycoind";
