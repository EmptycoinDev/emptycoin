    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Emptycoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/emptycoin"));
    setWindowIcon(QIcon(":icons/emptycoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Emptycoin address"));
    ...
    aboutAction = new QAction(tr("&About Emptycoin"), this);
    aboutAction->setToolTip(tr("Show information about Emptycoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Emptycoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/emptycoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/emptycoin_testnet"));
            setWindowIcon(QIcon(":icons/emptycoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/emptycoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Emptycoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Emptycoin client"));
...
void BitcoinGUI::restoreWindowGeometry()
{
    ...
    QSize size = settings.value("nWindowSize", QSize(800, 550)).toSize();
    if (!pos.x() && !pos.y())
    {
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Emptycoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Emptycoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        unsigned nEstimateTime = Params().GetTargetSpacing(nBestHeight) * nNetworkWeight / nWeight;
